...
class TransactionApi
{
     ...
     * @return \macropage\SDKs\ebay\rest\finance\Model\TransactionSummaryResponse
     */
     ...
     * @throws \macropage\SDKs\ebay\rest\finance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \macropage\SDKs\ebay\rest\finance\Model\TransactionSummaryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransactionSummaryWithHttpInfo($filter = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\macropage\SDKs\ebay\rest\finance\Model\TransactionSummaryResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\macropage\SDKs\ebay\rest\finance\Model\TransactionSummaryResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\macropage\SDKs\ebay\rest\finance\Model\TransactionSummaryResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\macropage\SDKs\ebay\rest\finance\Model\TransactionSummaryResponse',
     ...
     */
    protected function getTransactionSummaryRequest($filter = null)
    {
     ...
     * @throws \macropage\SDKs\ebay\rest\finance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \macropage\SDKs\ebay\rest\finance\Model\Transactions
     */
     ...
     * @throws \macropage\SDKs\ebay\rest\finance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \macropage\SDKs\ebay\rest\finance\Model\Transactions, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransactionsWithHttpInfo($filter = null, $sort = null, $limit = null, $offset = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\macropage\SDKs\ebay\rest\finance\Model\Transactions' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\macropage\SDKs\ebay\rest\finance\Model\Transactions', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\macropage\SDKs\ebay\rest\finance\Model\Transactions';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\macropage\SDKs\ebay\rest\finance\Model\Transactions',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTransactionsRequest($filter = null, $sort = null, $limit = null, $offset = null)
    {
