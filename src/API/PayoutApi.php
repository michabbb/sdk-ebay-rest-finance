...
class PayoutApi
{
     ...
     * Operation getPayout
     *
     * @param  string $payoutId The unique identfier of the payout is passed in as a path parameter at the end of the call URI. The getPayouts method can be used to retrieve the unique identifier of a payout, or the user can check Seller Hub to get the payout ID. (required)
     *
     ...
     */
    protected function getPayoutRequest($payoutId)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPayoutSummaryRequest($filter = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPayoutsRequest($filter = null, $sort = null, $limit = null, $offset = null)
    {
