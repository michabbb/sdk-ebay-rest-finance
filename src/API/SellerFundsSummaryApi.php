...
class SellerFundsSummaryApi
{
     ...
     * @return \macropage\SDKs\ebay\rest\finance\Model\SellerFundsSummaryResponse
     */
     ...
     * @throws \macropage\SDKs\ebay\rest\finance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \macropage\SDKs\ebay\rest\finance\Model\SellerFundsSummaryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSellerFundsSummaryWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\macropage\SDKs\ebay\rest\finance\Model\SellerFundsSummaryResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\macropage\SDKs\ebay\rest\finance\Model\SellerFundsSummaryResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\macropage\SDKs\ebay\rest\finance\Model\SellerFundsSummaryResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\macropage\SDKs\ebay\rest\finance\Model\SellerFundsSummaryResponse',
     ...
     */
    protected function getSellerFundsSummaryRequest()
    {
