...
class SellerFundsSummaryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['availableFunds'] = $data['availableFunds'] ?? null;
        $this->container['fundsOnHold'] = $data['fundsOnHold'] ?? null;
        $this->container['processingFunds'] = $data['processingFunds'] ?? null;
        $this->container['totalFunds'] = $data['totalFunds'] ?? null;
    }
