...
class Transfer implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $transactionDate This timestamp indicates the date/time of the transfer. The following (UTC) format is used: <code>YYYY-MM-DDTHH:MM:SS.SSSZ</code>. For example, <code>2020-08-04T19:09:02.768Z</code>
     *
     * @return self
     */
     ...
     * Sets transferId
     *
     * @param string|null $transferId The unique identifier of the <code>TRANSFER</code> transaction type. This is the same value that was passed into the end of the call URI.
     *
     * @return self
     */
